...
module Protobuf_unittest
  ...
  set_option :".protobuf_unittest.fileopt", { :i => 100, :s => "FileAnnotation", :sub => { :s => "NestedFileAnnotation" }, :file => { :".protobuf_unittest.fileopt" => { :s => "FileExtensionAnnotation" } }, :mset => {  } }
  ...
  class TestMessageWithCustomOptions
    ...
    optional :string, :field1, 1, :".protobuf_unittest.field_opt1" => 8765432109
  end
